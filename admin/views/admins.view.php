                        ...
                        <tbody>
                            <?php foreach ($administradores as $administrador) : ?>
                                <tr>
                                    ...
                                    <td><a href="mailto:<?php echo $administrador['user'] ?>" class="text-info"><?php echo $administrador['user'] ?></a></td>
                                    <td>
                                        <div class="btn-group col-12" role="group" aria-label="Basic example">
                                            <button type="button" class="btn btn-info col-6" data-toggle="modal" data-target="#editUser" data-registro="<?php echo base64_encode($administrador['id_user']) ?>" data-nombre="<?php echo $administrador['name'] ?>" data-usuario="<?php echo $administrador['user'] ?>" disabled>Editar</button>
                                            <button type=" button" class="btn btn-danger col-6" data-toggle="modal" data-target="#deleteUser" data-nombre="<?php echo $administrador['name'] ?>" data-registro="<?php echo base64_encode($administrador['id_user']) ?>" disabled>Elminar</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
